...
const EmailSection = () => {
  ...
  async function handleSubmit(event) {
    ...
    formData.append("access_key", "0f031885-ceec-49ce-8ac1-a1e2085421a6");
    ...
    >
      ...
      <div className="z-10">
        ...
        <p className="text-[#ADB7BE] mb-4 max-w-md text-justify">
          {" "}
          I'm actively exploring new opportunities, and my inbox is ready for
          your messages. Feel free to reach out if you have any questions or
          simply want to say hello—I'll do my best to respond!
        </p>
        <div className="socials flex flex-row gap-2">
          <Link href="https://github.com/sumit1617">
            <Image src={GithubIcon} alt="Github Icon" />
          </Link>
          <Link href="https://www.linkedin.com/in/singh-sumitkumar/">
